...
%   inputs/paths
dtroot      = '/autofs/space/nyx_002/users/rjones/47t/20220318_162703_MF275_2022_03_18_1_1/ed_proc';
filedir     = [dtroot]; % filesep 'diff/preproc/mri/eddy/results_def/dmri'];

fdwi        = [filedir filesep 'dwi_biascorr.nii.gz'];
fmask       = [filedir filesep 'brain_mask_edit.nii.gz'];
fbvec       = [filedir filesep 'diw.bvecs'];
fbval       = [filedir filesep 'dwi.bvals'];
flowb       = [filedir filesep 'dwi_biascorr.lowb.nii.gz']; %dtroot filesep 'preproc' filesep 'lowb_eddy_mean.nii.gz'];

outdir      = [dtroot filesep 'gdsi']; %[dtroot filesep 'preproc' filesep 'analysis' filesep 'gdsi' filesep 'results-testing'];
if ~exist(outdir,'dir')
