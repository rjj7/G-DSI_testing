function [ DATAOUT ] = script_GDSI_recon_HCP( verbose ) %( fconfig, verbose )
% 
...
fdwi        = [dtroot filesep 'preproc' filesep 'nufft/4sh' filesep 'data.nii.gz'];
fmask       = [dtroot filesep 'preproc' filesep 'nufft/4sh' filesep 'brain_mask.nii.gz'];
fbvec       = [dtroot filesep 'preproc' filesep 'nufft/4sh' filesep 'bvecs'];
fbval       = [dtroot filesep 'preproc' filesep 'nufft/4sh' filesep 'bvals'];
...
foutmat = [outdir filesep 'gdsi_recon_csdsi-nufft-hcp4sh7k_with-shelldens-corr_021022_slice_z35.mat'];
...
dec_hwhm_min = abs(DATAOUT.HWHMmin_vec).*repmat((DATAOUT.HWHMmin-3),1,1,3);
...
figure; hold on; plot(dat.rvec.wm.mean); plot(dat.rvec.gm.mean);title('Mean EAP - hcp 4sh 7k');
figure; hold on; plot(dat.rstd.wm.mean); plot(dat.rstd.gm.mean);title('GA profile - hcp 4sh 7k');
...
niioutdir = [outdir filesep 'gdsi_recon_csdsi-nufft-hcp4sh7k_with-shelldens-corr_021022_slice_z35'];
