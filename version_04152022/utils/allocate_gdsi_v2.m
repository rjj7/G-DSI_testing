function [ DATAOUT, DATAODF ] = allocate_gdsi_v2( voldims, nr, nr_odf )
%
% [ DATAOUT, DATAODF ] = allocate_gdsi_v2( voldims, nr, nr_odf )
% 
...
if nargin<2
    disp('USAGE: [ DATAOUT, DATAODF ] = allocate_gdsi_v2( voldims, nr[, nr_odf] )');
    return
end
if nargin<3
    nr_odf=[];
