function [ Rmatrix ] = compute_1d_eap_mtx_qvol( data, Fmtx, qvol )
%
% [ Rmatrix ] = compute_1d_eap_mtx_qvol( data, Fmtx )
% 
% -- For multishell data --
...
%  qvol    = qspace sampling density correction vector
...
for dirind=1:nb_dirs
    ...
    pdf_1d = F * diag(qvol) * data;      %calculate 1D PDF
